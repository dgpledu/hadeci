...
<html lang="en">
  <head>
    ...
    <title>Inscripción de organizadores</title>
  </head>
  <body>
 ...
 <div class="jumbotron jumbotron-fluid" id="contenedor_ppal" style="background:url('/imgs/patron.png')">
  ...
  <div class="card-header" style="background:#f2d333"><h5>Formulario de inscripción de organizadores</h5></div>
  <div class="card-body">
...
<h5><img src="/imgs/tilde-correcto-4.png" style="width:40px; height:40px;" alt="aprobado">
        ...
        <b> {{session('estado')}}, </b>
        Se ha inscripto correctamente como <b>organizador/a</b> en "Desafíos Científicos".
        <br><br>
...
<form class="" action="/inscripcionOrganizadores" method="post" enctype="multipart/form-data">
  {{ csrf_field() }}
  <div class="form-row">
