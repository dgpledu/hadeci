...
<html lang="en">
  <head>
    ...
    <title>Listado de docentes (día 1)</title>
  </head>
  <body>
 ...
 <div class="jumbotron jumbotron-fluid" id="contenedor_ppal" style="background:url('/imgs/patron.png')">
  ...
  <div class="card-header" style="background:#f2d333">
    <h4>Listado de docentes presentes (día 1)
...
<!-- fin de prueba -->
  ...
  <div class="card-body">
    ...
    <!-- tabla -->
    @php
      $numorden = ($todoslosdocentesD1->currentpage()-1)* $todoslosdocentesD1->perpage();
    @endphp
    {{-- @php
      $numorden = 0;
    @endphp --}}
    <table id="tabla-listado" class="table table-responsive table-striped">
      ...
      <tbody>
        @foreach ($todoslosdocentesD1 as $docente)
          @php
            $numorden++;
          @endphp
        <tr>
