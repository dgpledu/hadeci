...
<html lang="en">
  <head>
    ...
    <title>Inscripción de invitados</title>
  </head>
  <body>
 ...
 <div class="jumbotron jumbotron-fluid" id="contenedor_ppal" style="background:url('/imgs/patron.png')">
  ...
  <div class="card-header" style="background:#f2d333"><h5>Formulario de inscripción de invitados</h5></div>
  <div class="card-body">
...
<form class="" action="/inscripcionInvitados" method="post">
  {{ csrf_field() }}
  <div class="form-row">
  ...
  <div class="form-row">
    <div class="form-group col-sm-5">
        ...
        <small class="form-text text-muted">Ingrese el nombre y apellido de la persona que lo invitó a participar.</small>
    </div>
  </div>
