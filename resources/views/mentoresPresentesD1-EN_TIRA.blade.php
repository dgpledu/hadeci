      ...
      <div class="card-header" style="background:#ffebcc"><h4>Mentores presentes (día 1)</h4></div>
       <div class="card-body" >
        <h5 class="card-title">Hackatón "Desafíos Científicos" edición 2019</h5>
            <p class="card-text">Listado de los mentores presentes en el evento en el día 1</p>
...
@include('segundabarranav')
    ...
    $('html, body').animate({ scrollTop: $(document).height() - $(window).height() }, 2, function() {
        $(this).animate({ scrollTop: 0 }, 100000); //a mayor número más lento
    });
      </script>
