...
<form class="" action="/cargarDesafios" method="post">
  ...
  <div class="form-row">
    <div class="form-group col-sm-4.5">
      <input type="text" name="codigo_desafio" class="form-control" placeholder="código">
      <small class="form-text text-muted">Ingresar el código del desafío</small>
    </div>
    <div class="form-group col-sm-4.5">
      <input type="text" name="nombre_desafio" class="form-control" placeholder="nombre del desafío">
        <small class="form-text text-muted">Ingresar el nombre del desafío</small>
    </div>
  </div>
      <div class="form-row">
    <div class="form-group col-sm-9">
      <label for="descripcion_des">Descripción del desafío</label>
    <textarea class="form-control" id="descripcion_des" name="descripcion_desafio" rows="3"></textarea>
</div>
    </div>
