...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
    ...
    <title>Listado de otros perfiles</title>
...
{{-- <link rel="stylesheet" href="/css/bootstrap.min.css">--}}
 ...
 <div class="jumbotron jumbotron-fluid" id="contenedor_ppal" style="background:url('/imgs/patron.png')">
  ...
  <div class="card-header" style="background:#f2d333">
    <h4>Listado de otros perfiles presentes (ambos días)
{{-- <span class="badge badge-primary badge-pill">{{count($todoslosmentores)}}</span> --}}
</h4>
<h5>
<span class="badge badge-primary badge-pill">
{{ $todoslosotrosperfiles->firstItem() }}
</span>
<span class="">
a
</span>
<span class="badge badge-primary badge-pill">
{{ $todoslosotrosperfiles->lastItem() }}
</span>
<span class="">
de un total de
</span>
<span class="badge badge-primary badge-pill">
{{ $todoslosotrosperfiles->total() }}
</span>
<!-- Fin de cartel x a y de un total de n elementos -->
  ...
  {{-- <div class="card-body bg-light"> <!-- contiene la tabla para darle margen --> --}}
    ...
    <!-- tabla -->
    @php
      $numorden = ($todoslosotrosperfiles->currentpage()-1)* $todoslosotrosperfiles->perpage();
    @endphp
    <table id="tabla-listado" class="table table-sm table-responsive table-striped">
      ...
      <tbody>
        @foreach ($todoslosotrosperfiles as $otro)
          @php
            $numorden++;
          @endphp
        <tr>
