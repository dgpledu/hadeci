...
<html lang="en">
  <head>
    ...
    <title>Inscripción de colaboradores</title>
  </head>
  <body>
 ...
 <div class="jumbotron jumbotron-fluid" id="contenedor_ppal" style="background:url('/imgs/patron.png')">
  ...
  <div class="card-header" style="background:#f2d333"><h5>Formulario de inscripción de colaboradores</h5></div>
  <div class="card-body">
...
<h5><img src="/imgs/tilde-correcto-4.png" style="width:40px; height:40px;" alt="aprobado">
        ...
        <br><br>
        <img src="/imgs/icono-mail-enviado.png" style="width:40px; height:40px;" alt="mail"> Se ha enviado un mail a <b>{{session('correo')}}</b> confirmando su inscripción y detallando información importante para el evento.
...
<form class="" action="/inscripcionColaboradores" method="post">
  {{ csrf_field() }}
  <div class="form-row">
  ...
  <div class="form-group col-sm-5">
      ...
      <small class="form-text text-muted">Ingrese el nombre y apellido de la persona que lo invitó a participar como colaborador.</small>
  </div>
