...
<html lang="en">
  <head>
    ...
    <title>Inscripción de jurados</title>
  </head>
  <body>
 ...
 <div class="jumbotron jumbotron-fluid" id="contenedor_ppal" style="background:url('/imgs/patron.png')">
  ...
  <div class="card-header" style="background:#f2d333"><h5>Formulario de inscripción de jurados</h5></div>
  <div class="card-body">
...
<h5><img src="/imgs/tilde-correcto-4.png" style="width:40px; height:40px;" alt="aprobado">
        ...
        <b> {{session('estado')}}, </b>
        Se ha inscripto correctamente como <b>jurado</b> en "Desafíos Científicos".
        <br><br>
...
<form class="" action="/inscripcionJurados" method="post" enctype="multipart/form-data">
  {{ csrf_field() }}
  <div class="form-row">
  ...
  <div class="form-group col-sm-2.5">
    ...
    <small class="form-text text-muted">Ingrese su número de celular (sin 0 y sin 15)</small>
  </div>
  </div>
  ...
  <div class="form-row">
      <div class="form-group col-sm-5">
          ...
          <small class="form-text text-muted">Ingrese el nombre y apellido de la persona que lo invitó a participar como jurado.</small>
      </div>
      <div class="form-group col-sm-5">
  ...
  <div class="form-row">
      ...
      <div class="form-group col-sm-5">
          ...
          <small class="form-text text-muted">Ingrese una breve descripción de su perfil laboral. Esto será útil para su presentación como autoridad del evento. Tamaño máximo: 255 caracteres.</small>
        </div>
  ...
  <div class="form-row">
    <div class="form-group col-sm-6">
      <input type="file" name="foto_jurado" class="form-control-file" placeholder="Foto personal">
