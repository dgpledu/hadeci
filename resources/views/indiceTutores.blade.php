...
<!-- Prueba de borrar tutor -->
          ...
          <form action="/editarTutores" method="post">
      {{ csrf_field() }}
      <input type="hidden" name="ID_tutor_a_editar" value="{{$tutor["ID"]}}">
           ...
           <form action="" method="post">
              {{ csrf_field() }}
              <input type="hidden" name="ID_tutor_a_borrar" value="{{$tutor["ID"]}}">
                  {{-- <button class="btn-sm btn-danger btn-xs" type="submit">Borrar</button> --}}
                  <input type="image" img src="/imgs/icono-borrar.png" style="width:30px;height:30px;">
            </form>
          </td>
