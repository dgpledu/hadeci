...
<html lang="en">
  <head>
    ...
    <title>Listado de docentes (día 2)</title>
  </head>
  <body>
 ...
 <div class="jumbotron jumbotron-fluid" id="contenedor_ppal" style="background:url('/imgs/patron.png')">
  ...
  <div class="card-header" style="background:#f2d333">
    <h4>Listado de docentes presentes (día 2)
...
<h5>
<span class="badge badge-primary badge-pill">
{{ $todoslosdocentesD2->firstItem() }}
</span>
<span class="">
a
</span>
<span class="badge badge-primary badge-pill">
{{ $todoslosdocentesD2->lastItem() }}
</span>
<span class="">
de un total de
</span>
<span class="badge badge-primary badge-pill">
{{ $todoslosdocentesD2->total() }}
</span>
<!-- Fin de cartel x a y de un total de n elementos -->
    </h5>
<!-- fin de prueba -->
  ...
  <div class="card-body">
    ...
    <!-- tabla -->
    @php
      $numorden = ($todoslosdocentesD2->currentpage()-1)* $todoslosdocentesD2->perpage();
    @endphp
    {{-- @php
      $numorden = 0;
    @endphp --}}
    <table id="tabla-listado" class="table table-responsive table-striped">
      ...
      <tbody>
        @foreach ($todoslosdocentesD2 as $docente)
          @php
            $numorden++;
          @endphp
        <tr>
  ...
  <!-- tabla para paginación -->
    <table class="table table-responsive ">
      ...
      <tbody>
        <tr>
          <th scope="row">{{$todoslosdocentesD2->links()}}<a class="btn " style="background:#f2d333; color: black;" href="/consultas" role="button">Volver a Consultas</a></th>
        </tr>
      </tbody>
    </table>
