...
<html lang="en">
  <head>
    ...
    <title>Inscripción de autoridades</title>
  </head>
  <body>
 ...
 <div class="jumbotron jumbotron-fluid" id="contenedor_ppal" style="background:url('/imgs/patron.png')">
  ...
  <div class="card-header" style="background:#f2d333"><h5>Formulario de inscripción de autoridades</h5></div>
  <div class="card-body">
...
<form class="" action="/inscripcionAutoridades" method="post" enctype="multipart/form-data">
  {{ csrf_field() }}
  <div class="form-row">
  ...
  <div class="form-row">
      <div class="form-group col-sm-5">
          ...
          <small class="form-text text-muted">Ingrese una breve descripción de su perfil profesional. Esto será útil para su presentación como autoridad destacada. Tamaño máximo: 255 caracteres.</small>
        </div>
